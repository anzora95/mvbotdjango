...
class InstaBot:
    ...
    def __init__(self,
        ...
        # Get tag, from tag_list, and like (1 to n) times.
        ...
        log_string = 'NgageSocial started at %s:\n' % \
    ...
    def get_instagram_url_from_media_id(self, media_id, url_flag=True, only_code=None):   #obtiene una url completa con el media_id
        ...
        if self.login_status:
            if self.login_status == 1:
                ...
                try:
                    ...
                    follower = user_info['followed_by']['count']   #en la url del json ya no se llama follows sino edge_followed_by
